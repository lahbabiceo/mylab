                      ...
                      children: [
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              SmallText(text: MyStrings.nextReturn, textStyle: interRegularExtraSmall.copyWith(color: MyColor.colorGrey)),
                              const SizedBox(height: Dimensions.space5),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              SmallText(text: MyStrings.totalReturn, textStyle: interRegularExtraSmall.copyWith(color: MyColor.colorGrey)),
                              const SizedBox(height: Dimensions.space5),
