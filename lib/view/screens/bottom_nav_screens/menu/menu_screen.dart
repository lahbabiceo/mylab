...
class _MenuScreenState extends State<MenuScreen> {
  ...
  void initState() {
    ...
    final controller = Get.put(MenuController(repo: Get.find()));
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ThemeController>(builder: (theme){
      return GetBuilder<LocalizationController>(builder: (localizationController){
        return  GetBuilder<MenuController>(builder: (menuController)=>SafeArea(
          child: Scaffold(
            ...
            body: menuController.isLoading?const CustomLoader():SingleChildScrollView(
                ...
                children: [
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        DefaultText(text: MyStrings.setting, textStyle: interRegularDefault.copyWith(color: MyColor.colorGrey)),
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        DefaultText(text: "${MyStrings.helpAndSetting.tr}", textStyle: interRegularDefault.copyWith(color: MyColor.colorGrey)),
                        const SizedBox(height: Dimensions.space15),
