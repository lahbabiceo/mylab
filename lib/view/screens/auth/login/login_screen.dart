                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Expanded(
                              flex:10,
                              child: Text(MyStrings.notRegistered.tr, overflow:TextOverflow.ellipsis,style: interRegularLarge.copyWith(color: MyColor.getTextColor2(), fontWeight: FontWeight.w500)),
                            ),
                            ...
                            Expanded(
                              ...
                              child: TextButton(
                                ...
                                child: Text(MyStrings.createAccount.tr, maxLines: 2, overflow:TextOverflow.ellipsis,style: interRegularLarge.copyWith(color: MyColor.getPrimaryColor())),
                              ),
                            )
                          ],
                        )
