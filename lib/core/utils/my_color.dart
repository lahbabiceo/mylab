...
class MyColor{
  ...
  static const Color splashBgColor =  Color(0xffff9900);
  static const Color appBarColor = Color(0xff192D36);

  static const Color fieldEnableBorderColor = Color(0xffff9900);
  ...
  static const Color secondaryTextColor = Color(0xffff9900);
  ...
  static const Color colorGolden = Color(0xffff9900);
